...
> Foi preciso utilizar "import sys" para otimizar a leitura da mensagem encriptada e "from math import floor, ceil" para as operações matemáticas, como no caso da questão, o uso da raiz do tamanho e o arredondamento "floor" e "ceil".
